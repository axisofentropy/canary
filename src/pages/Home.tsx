  ...
  function getReviews(search) {
    ...
    database
      ...
      .then((data) => {
        ...
        reviews_data = filterReviews(reviews_data, keys, {threshold: 0.2});
    ...
    <div className="Home">
      <div className="jumbotron">
        <div className="jumbotron__content">
          <h1>
            Don't go into your internship <b>blind</b>
          </h1>
              ...
              {reviews ? (
                reviews.length > 0 ? (
                  reviews
                    ...
                    .map((review, i) => <CompanyCard key={review.id} name={review.company.name} image={review.company.image} description={review.company.description} reviews={[review]} />)
                ) : (
                  <Result status="warning" title="Search returned 0 results" style={{ gridColumn: "1 / 3" }} />
                )
              ) : (
                <Spin size="large" />
              )}
